...
const AttendeeDashboard = () => {
  ...
  useEffect(() => {
    getResearchPapers(), getWorkshopDetails();
  }, []);

  const getResearchPapers = () => {
    axios.get("/reviewer/approvEDResearches").then((res) => {
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="column">
          ...
          <h5>
            Make Sure to Protect Author Rights !!!. Not Share thease Reseaches
            with Unathorized Users.
          </h5>
          <div>
            {researches.length === 0 ? (
              <p>
              ...
              researches.map((value, index) => (
                <div key={index} className="card mb-3">
                  <div className="p-3">
                    ...
                    <button
                      className="downbtn downbtn_Effect"
                      onClick={(e) => {
                        navigateDownload(e, value.uploads);
                      }}
                    >
                      View and Download Research
                    </button>
                  </div>
                </div>
              ))
              ...
              workshops.map((value, index) => (
                <div key={index} className="card mb-3">
                  <div className="p-3">
                    ...
                    >
                      View and Download Workshop Details
                    </button>
                  </div>
                </div>
              ))
